...
// import Employeemodel from 'App/Controllers/Http/Employeemodel'
...
Route.put('updation/:id','Employeemodel.updation')
Route.delete("Deletion/:id",'Employeemodel.deletion')
Route.get("/searchdet/",'Employeemodel.searchAll')
...
Route.get("joins",'departmentmodel.joinAll')
Route.get('joinByID/:id','departmentmodel.joinTablesById')
// }).middleware('Employeemiddleware')
// Route.patch('updation/:id', async ({ request, response }) => {
//   response.header('Access-Control-Allow-Origin', '*');
//   response.header('Access-Control-Allow-Methods', 'GET, PUT, PATCH, DELETE');
//   response.header('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept');

//   // Call the appropriate method from the 'Employeemodel' to handle the update operation
//   await Employeemodel.updation(request, response);
// });
